...
import {
  ViewPlay, ViewTeams, ViewBracket, ViewStandings, ViewEarn,
...
const MENU_LINKS = [
  ['#/', 'Play'], ['#/teams', 'Teams'], ['#/bracket', 'Bracket'],
...
export default function App() {
  ...
  const r = route || '#/';
  const isPlay = r === '#/' || r === '' || r.startsWith('#/login') || r.startsWith('#/critique');

  let view;
  if (r === '#/' || r === '') view = <ViewPlay ctx={ctx} />;
